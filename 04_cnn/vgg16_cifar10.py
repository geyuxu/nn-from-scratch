"""
VGG16 for CIFAR-10 (类结构，不使用 nn.Module)
...
plt.tight_layout()
plt.savefig('04_cnn/Figure_vgg16_cifar10.png', dpi=150)
plt.show()

print("\n报告已保存到 04_cnn/Figure_vgg16_cifar10.png")
